...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  let (:new_advertisement) { Advertisement.create!(title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: RandomData.random_number) }
  ...
  describe "GET #show" do
    ...
    it "assigns advertisement to @post" do
      get :show, {id: new_advertisement.id}
  ...
  describe "Advertisement create" do
    it "it increases number of the Advertisement by 1" do
